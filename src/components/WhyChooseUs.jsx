  ...
  return (
    <section className="relative py-20 lg:py-32 bg-[#0f172a] overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
        <div className="absolute -top-[20%] -left-[10%] w-[50%] h-[50%] rounded-full bg-[#ff8c00]/5 blur-[120px]"></div>
          ...
          {features.map((feature, idx) => {
            ...
            return (
              ...
              >
                ...
                <span className="absolute -top-6 -right-4 text-[120px] font-black text-slate-700/20 group-hover:text-[#ff8c00]/10 transition-colors duration-500 select-none">
                  {feature.id}
                </span>

                <div className="relative z-10">
                  <div className="w-14 h-14 rounded-2xl bg-[#ff8c00]/10 flex items-center justify-center mb-8 border border-[#ff8c00]/20 group-hover:scale-110 transition-transform duration-500">
