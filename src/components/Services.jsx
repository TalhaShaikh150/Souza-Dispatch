    ...
    <section className="py-16 lg:py-20 bg-slate-50 border-t border-gray-100" id="services">
      <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-12 gap-6">
          <div>
            <span className="text-[#ff8c00] font-semibold text-[13px] tracking-wider uppercase mb-2 block">
              OUR SERVICES
            </span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-10">
          {services.map((service, idx) => (
            ...
            >
              {/* Card Image */}
              <div className="relative w-full h-[240px] sm:h-[280px] lg:h-[320px] overflow-hidden bg-gray-100">
                <Image 
                  src={service.image} 
                  alt={service.title} 
                  fill 
                ...
                />
                <span className="absolute top-3 left-3 bg-black/60 backdrop-blur-sm text-white text-[11px] font-medium px-2.5 py-1 rounded-full uppercase tracking-wider">
                  {service.tag}
                </span>
              </div>
              ...
              <div className="p-7 sm:p-9 flex flex-col flex-grow">
                <h3 className="text-[22px] sm:text-[24px] font-bold text-[#0f172a] mb-3 group-hover:text-[#ff8c00] transition-colors">
                  {service.title}
                </h3>
                ...
                <Link 
                  href={service.link} 
                  className="inline-flex items-center gap-1.5 text-[#ff8c00] font-bold text-[15px] hover:text-[#e07b00] transition-all mt-auto group-hover:gap-2 duration-300"
                >
