      ...
      <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-brand-white rounded-2xl shadow-sm border border-brand-gray/50 p-8 md:p-12 max-w-[800px] mx-auto">
          ...
          <form className="space-y-6">
            ...
            <button type="submit" className="w-full py-4 bg-[#00ace0] text-white font-bold rounded-xl shadow-sm hover:bg-[#0095c2] transition-colors focus:outline-none text-[15px]">
              Submit Request
            </button>
          </form>
          ...
          <div className="mt-8 pt-8 border-t border-gray-100 flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-3">
              <a 
                ...
                className="w-10 h-10 rounded-full bg-slate-100 flex items-center justify-center text-slate-700 hover:bg-[#00ace0] hover:text-white transition-colors"
                aria-label="Facebook"
              >
