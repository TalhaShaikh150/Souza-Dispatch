...
export default function RootLayout({
  ...
  return (
    <html lang="en" className={inter.variable}>
      <body className="antialiased font-primary text-brand-dark bg-brand-white relative min-h-screen">
        <Header />
        ...
        {/* Fixed Google Review Tab (Bottom Left) with Interactive Popup */}
        <GoogleReviewBadge />
        ...
        <a 
          ...
          className="fixed bottom-6 right-6 z-50 w-12 h-12 bg-[#25D366] text-white rounded-full flex items-center justify-center shadow-lg hover:shadow-xl transition-shadow"
